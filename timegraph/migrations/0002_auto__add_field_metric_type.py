...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Metric.type'
        db.add_column('timegraph_metric', 'type', self.gf('django.db.models.fields.CharField')(default='float', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Metric.type'
        db.delete_column('timegraph_metric', 'type')
    ...
    models = {
        ...
        'timegraph.metric': {
            ...
            'cumulative': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'device': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
