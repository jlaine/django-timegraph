...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Metric.cumulative'
        db.delete_column('timegraph_metric', 'cumulative')


    def backwards(self, orm):
        
        # Adding field 'Metric.cumulative'
        db.add_column('timegraph_metric', 'cumulative', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
